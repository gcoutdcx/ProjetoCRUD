...
namespace Azure {
	public static class AzureStorage {
		...
		public static void Upload(string pasta, string arquivo, byte[] buffer, string container, int inicio, int tamanho, string azureConnectionString) {
		...
		public static void Upload(string pasta, string arquivo, Stream stream, string container, string azureConnectionString) {
			CloudBlockBlob blob = BlobReference(pasta, arquivo, container, false, azureConnectionString);
			if (blob == null)
				return;
			blob.Properties.ContentType = ContentType(arquivo);
		...
		public static void Upload(string pasta, string arquivo, string caminhoArquivoLocal, string container, string azureConnectionString) {
			CloudBlockBlob blob = BlobReference(pasta, arquivo, container, false, azureConnectionString);
			if (blob == null)
				return;
			blob.Properties.ContentType = ContentType(arquivo);
		...
		public static bool Existe(string pasta, string arquivo, string container, string azureConnectionString) {
			return (BlobReference(pasta, arquivo, container, true, azureConnectionString) != null);
		}

		public static void Delete(string pasta, string arquivo, string container, string azureConnectionString) {
		...
		public static byte[] DownloadBytes(string pasta, string arquivo, string container, string azureConnectionString) {
			CloudBlockBlob blob = BlobReference(pasta, arquivo, container, true, azureConnectionString);
			if (blob == null)
				return null;
		...
		public static MemoryStream DownloadStream(string pasta, string arquivo, string container, string azureConnectionString) {
			CloudBlockBlob blob = BlobReference(pasta, arquivo, container, true, azureConnectionString);
			if (blob == null)
				return null;
		...
		public static IEnumerable<IListBlobItem> Listar(string pasta, string prefixoArquivo, string container, string azureConnectionString) {
